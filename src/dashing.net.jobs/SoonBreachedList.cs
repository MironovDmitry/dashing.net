...
namespace dashing.net.jobs
{
    ...
    public class SoonBreachedList : IJob
    {
        ...
        public SoonBreachedList()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    wo.workorderDelay = Convert.ToInt16(reader["minutesLeft"].ToString()).ToString();
        ...
        public void SendMessage(object sent)
        {
            ...
            Dashing.SendMessage(new { id = "soonBreachedList", rows });
        }
